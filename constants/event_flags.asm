...
; Johto hidden items
	...
	const EVENT_VICTORY_ROAD_3F_HIDDEN_MAX_POTION
	const EVENT_VICTORY_ROAD_2F_HIDDEN_FULL_HEAL
...
; Johto people
	...
	const EVENT_RIVAL_VICTORY_ROAD_3F
...
; Unused: next 48 events
	const EVENT_BOULDER_IN_VICTORY_ROAD_1
	const EVENT_BOULDER_IN_VICTORY_ROAD_1A
